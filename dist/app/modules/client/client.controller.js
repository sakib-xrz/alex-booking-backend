...
__export(client_controller_exports, {
  default: () => client_controller_default
});
...
var import_client = __toESM(require("./client.services"));
const GetCounselorClients = (0, import_catchAsync.default)(async (req, res) => {
  const result = await import_client.default.GetCounselorClientsById(req.user.id);
...
var client_controller_default = ClientController;
